    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-20">
        <div className="container mx-auto px-6">
          <h1 className="text-5xl font-bold mb-4">Transmission Repair Services in Dubai</h1>
          <p className="text-xl text-gray-300">Expert automatic & manual transmission repair for BMW, Mercedes, Audi, Toyota, Honda, Nissan, and all car brands</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Professional Transmission Repair Dubai</h2>
              <p className="text-gray-700 mb-4">
                Al Suwaidi Auto Repair Garage specializes in transmission repair and service for all vehicle types in Dubai. Whether you drive a BMW, Mercedes-Benz, Audi, Porsche, Range Rover, Toyota, Honda, Nissan, or any other brand, our experienced technicians can diagnose and fix all transmission issues.
              </p>
              <p className="text-gray-700 mb-4">
                We handle both automatic and manual transmissions with advanced diagnostic equipment at our Umm Ramool, Al Rashidiya workshop. From minor repairs to complete transmission rebuilds, we ensure smooth shifting and optimal performance.
              </p>
              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8">Transmission Services:</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Automatic transmission repair & rebuild</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Manual transmission repair & clutch replacement</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>CVT transmission service & repair</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Transmission fluid flush & change</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Gearbox diagnostics & scanning</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Transmission filter replacement</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Torque converter repair</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Transmission solenoid replacement</span>
                </li>
              </ul>
            </div>
            <div>
              <div className="bg-gray-100 p-8 rounded-lg mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Common Transmission Problems</h3>
                <div className="space-y-3 text-gray-700">
                  <p>• Slipping gears or delayed shifting</p>
                  <p>• Grinding or shaking when shifting</p>
                  <p>• Burning smell from transmission</p>
                  <p>• Transmission fluid leaks</p>
                  <p>• Check engine light (transmission codes)</p>
                  <p>• Difficulty shifting gears</p>
                  <p>• Strange noises from gearbox</p>
                  <p>• Clutch problems (manual transmission)</p>
                </div>
              </div>

              <div className="bg-red-600 text-white p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-3">Transmission Problems? Get Expert Help</h3>
                <p className="mb-4">Fast diagnosis, reliable repair, competitive pricing</p>
      ...
      <section className="bg-gray-100 py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">We Service All Car Brand Transmissions</h2>
          <p className="text-center text-gray-600 mb-12">Expert transmission repair for automatic, manual, and CVT transmissions</p>
