    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-20">
        <div className="container mx-auto px-6">
          <h1 className="text-5xl font-bold mb-4">Car Engine Repair & Service in Dubai</h1>
          <p className="text-xl text-gray-300">Professional engine repair specialists for BMW, Mercedes, Audi, Toyota, Honda, Nissan, and all car brands in Dubai</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Expert Engine Repair Services Dubai</h2>
              <p className="text-gray-700 mb-4">
                Al Suwaidi Auto Repair Garage is Dubai's trusted car engine repair specialist. We service all car brands including German luxury cars (BMW, Mercedes-Benz, Audi, Porsche), Japanese vehicles (Toyota, Honda, Nissan), and all other makes. Our workshop in Umm Ramool, Al Rashidiya is equipped with advanced diagnostic equipment.
              </p>
              <p className="text-gray-700 mb-4">
                Whether it's a minor engine issue or major overhaul, our expert mechanics have over 20 years of experience diagnosing and fixing engine problems. We understand Dubai's harsh climate and how it affects your engine.
              </p>
              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8">Engine Services We Offer:</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Engine diagnostics and scanning</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Engine overhaul and rebuild</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Timing belt/chain replacement</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Head gasket repair</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Oil leak repair</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Engine cooling system repair</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Turbocharger repair and replacement</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">✓</span>
                  <span>Fuel injection system repair</span>
                </li>
              </ul>
            </div>
            <div>
              <div className="bg-gray-100 p-8 rounded-lg mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Common Engine Problems We Fix</h3>
                <div className="space-y-3 text-gray-700">
                  <p>• Engine overheating</p>
                  <p>• Check engine light diagnosis</p>
                  <p>• Poor acceleration and power loss</p>
                  <p>• Engine misfires and rough idle</p>
                  <p>• Oil consumption issues</p>
                  <p>• Engine noise and knocking</p>
                  <p>• Starting problems</p>
                  <p>• Exhaust smoke (white, blue, black)</p>
                </div>
              </div>

              <div className="bg-red-600 text-white p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-3">Need Engine Repair? Contact Us Today</h3>
                <p className="mb-4">Fast diagnosis, expert repair, competitive prices</p>
      ...
      <section className="bg-gray-100 py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">We Service All Car Brand Engines</h2>
          <p className="text-center text-gray-600 mb-12">Expert engine repair for German, Japanese, American, and all other car brands in Dubai</p>
